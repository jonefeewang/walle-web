    ...
    <div id="login-box" class="login-box visible widget-box no-border">
        <div class="widget-body">
            <div class="widget-main">
                ...
                <?= $form->field($model, 'username')->textInput(['placeholder'    => yii::t('w', 'login username tip')])->label(yii::t('w', 'login username')) ?>
                <?= $form->field($model, 'password')->passwordInput(['placeholder'    => yii::t('w', 'login password tip')])->label(yii::t('w', 'login password')) ?>
